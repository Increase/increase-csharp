...
public sealed record class RealTimePaymentsTransfer : JsonModel
{
    ...
    /// </summary>
    public required string? InboundRealTimePaymentsRequestForPaymentID
    {
        get
        {
            this._rawData.Freeze();
        ...
        init { this._rawData.Set("inbound_real_time_payments_request_for_payment_id", value); }
    }
    ...
    public override void Validate()
    {
        ...
        _ = this.InboundRealTimePaymentsRequestForPaymentID;
