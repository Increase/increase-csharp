...
/// </summary>
public record class RealTimePaymentsTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public RealTimePaymentsTransferListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public RealTimePaymentsTransferListParams(
        RealTimePaymentsTransferListParams realTimePaymentsTransferListParams
    )
        : base(realTimePaymentsTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static RealTimePaymentsTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(RealTimePaymentsTransferListParams? other)
    {
        if (other == null)
        {
            return false;
