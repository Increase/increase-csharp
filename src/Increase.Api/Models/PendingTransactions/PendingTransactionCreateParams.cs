...
/// negative amounts are supported). The resulting Pending Transaction will have
/// a `category` of `user_initiated_hold` and can be released via the API to unlock
/// the held funds.
///
...
/// </summary>
public record class PendingTransactionCreateParams : ParamsBase
{
    ...
    public PendingTransactionCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PendingTransactionCreateParams(
        PendingTransactionCreateParams pendingTransactionCreateParams
    )
        : base(pendingTransactionCreateParams)
    {
        this._rawBodyData = new(pendingTransactionCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PendingTransactionCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(PendingTransactionCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/pending_transactions")
        {
