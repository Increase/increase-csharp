...
/// </summary>
public record class IntrafiExclusionListParams : ParamsBase
{
    /// <summary>
    ...
    public string? EntityID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("entity_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("entity_id", value);
        }
    }
    ...
    public IntrafiExclusionListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IntrafiExclusionListParams(IntrafiExclusionListParams intrafiExclusionListParams)
        : base(intrafiExclusionListParams) { }
...
#pragma warning restore CS8618
    ...
    public static IntrafiExclusionListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(IntrafiExclusionListParams? other)
    {
        if (other == null)
        {
            return false;
