...
/// </summary>
public record class IntrafiExclusionArchiveParams : ParamsBase
{
    public string? IntrafiExclusionID { get; init; }

    public IntrafiExclusionArchiveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public IntrafiExclusionArchiveParams(
        IntrafiExclusionArchiveParams intrafiExclusionArchiveParams
    )
        : base(intrafiExclusionArchiveParams)
    {
...
#pragma warning restore CS8618
    ...
    public static IntrafiExclusionArchiveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string intrafiExclusionID
    )
    ...
    public virtual bool Equals(IntrafiExclusionArchiveParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/intrafi_exclusions/{0}/archive", this.IntrafiExclusionID)
        )
        {
