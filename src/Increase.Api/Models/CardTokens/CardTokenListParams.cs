...
/// </summary>
public record class CardTokenListParams : ParamsBase
{
    ...
    public CardTokenListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CardTokenListParams(CardTokenListParams cardTokenListParams)
        : base(cardTokenListParams) { }
...
#pragma warning restore CS8618
    ...
    public static CardTokenListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CardTokenListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/card_tokens")
        {
