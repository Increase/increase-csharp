...
/// </summary>
public record class PhysicalCardListParams : ParamsBase
{
    /// <summary>
    ...
    public PhysicalCardListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PhysicalCardListParams(PhysicalCardListParams physicalCardListParams)
        : base(physicalCardListParams) { }
...
#pragma warning restore CS8618
    ...
    public static PhysicalCardListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(PhysicalCardListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/physical_cards")
        {
