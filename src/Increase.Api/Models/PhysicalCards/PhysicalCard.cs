...
public enum Category
{
    ...
    /// <summary>
    /// The physical card has been delivered. Note that some couriers track delivery
    /// status based on driver location data rather than an explicit scan. While
    /// uncommon, a single physical card may have more than one delivered event.
    /// </summary>
    Delivered,
