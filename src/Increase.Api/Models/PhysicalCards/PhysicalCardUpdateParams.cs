...
/// </summary>
public record class PhysicalCardUpdateParams : ParamsBase
{
    ...
    public PhysicalCardUpdateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PhysicalCardUpdateParams(PhysicalCardUpdateParams physicalCardUpdateParams)
        : base(physicalCardUpdateParams)
    {
        this.PhysicalCardID = physicalCardUpdateParams.PhysicalCardID;

        this._rawBodyData = new(physicalCardUpdateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static PhysicalCardUpdateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData,
        string physicalCardID
    ...
    public virtual bool Equals(PhysicalCardUpdateParams? other)
    {
        if (other == null)
        {
            return false;
