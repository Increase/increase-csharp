...
/// </summary>
public record class PhysicalCardProfileRetrieveParams : ParamsBase
{
    public string? PhysicalCardProfileID { get; init; }

    public PhysicalCardProfileRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PhysicalCardProfileRetrieveParams(
        PhysicalCardProfileRetrieveParams physicalCardProfileRetrieveParams
    )
        : base(physicalCardProfileRetrieveParams)
    {
...
#pragma warning restore CS8618
    ...
    public static PhysicalCardProfileRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string physicalCardProfileID
    )
    ...
    public virtual bool Equals(PhysicalCardProfileRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/physical_card_profiles/{0}", this.PhysicalCardProfileID)
        )
        {
