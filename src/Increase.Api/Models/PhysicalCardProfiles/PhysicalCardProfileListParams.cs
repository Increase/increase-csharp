...
/// </summary>
public record class PhysicalCardProfileListParams : ParamsBase
{
    /// <summary>
    ...
    public PhysicalCardProfileListParams() { }
...
#pragma warning disable CS8618
    ...
    public PhysicalCardProfileListParams(
        ...
        : base(physicalCardProfileListParams) { }
...
#pragma warning restore CS8618
    ...
    public static PhysicalCardProfileListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(PhysicalCardProfileListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/physical_card_profiles"
        )
        {
