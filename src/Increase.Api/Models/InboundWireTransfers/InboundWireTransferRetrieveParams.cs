...
/// </summary>
public record class InboundWireTransferRetrieveParams : ParamsBase
{
    public string? InboundWireTransferID { get; init; }

    public InboundWireTransferRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public InboundWireTransferRetrieveParams(
        InboundWireTransferRetrieveParams inboundWireTransferRetrieveParams
    )
        : base(inboundWireTransferRetrieveParams)
    {
...
#pragma warning restore CS8618
    ...
    public static InboundWireTransferRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string inboundWireTransferID
    )
    ...
    public virtual bool Equals(InboundWireTransferRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format("/inbound_wire_transfers/{0}", this.InboundWireTransferID)
        )
        {
