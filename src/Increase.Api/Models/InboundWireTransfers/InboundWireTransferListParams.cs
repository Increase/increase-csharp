...
/// </summary>
public record class InboundWireTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public string? WireDrawdownRequestID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("wire_drawdown_request_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("wire_drawdown_request_id", value);
        }
    }

    public InboundWireTransferListParams() { }
...
#pragma warning disable CS8618
    ...
    public InboundWireTransferListParams(
        ...
        : base(inboundWireTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static InboundWireTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(InboundWireTransferListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/inbound_wire_transfers"
        )
        {
