...
/// </summary>
public record class EventSubscriptionListParams : ParamsBase
{
    /// <summary>
    ...
    public EventSubscriptionListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public EventSubscriptionListParams(EventSubscriptionListParams eventSubscriptionListParams)
        : base(eventSubscriptionListParams) { }
...
#pragma warning restore CS8618
    ...
    public static EventSubscriptionListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(EventSubscriptionListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/event_subscriptions")
        {
