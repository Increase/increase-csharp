...
/// </summary>
public record class ExternalAccountRetrieveParams : ParamsBase
{
    public string? ExternalAccountID { get; init; }

    public ExternalAccountRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public ExternalAccountRetrieveParams(
        ExternalAccountRetrieveParams externalAccountRetrieveParams
    )
        : base(externalAccountRetrieveParams)
    {
...
#pragma warning restore CS8618
    ...
    public static ExternalAccountRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string externalAccountID
    )
    ...
    public virtual bool Equals(ExternalAccountRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
