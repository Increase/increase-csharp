...
/// </summary>
public record class SupplementalDocumentListParams : ParamsBase
{
    /// <summary>
    ...
    public SupplementalDocumentListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SupplementalDocumentListParams(
        SupplementalDocumentListParams supplementalDocumentListParams
    )
        : base(supplementalDocumentListParams) { }
...
#pragma warning restore CS8618
    ...
    public static SupplementalDocumentListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(SupplementalDocumentListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/entity_supplemental_documents"
        )
        {
