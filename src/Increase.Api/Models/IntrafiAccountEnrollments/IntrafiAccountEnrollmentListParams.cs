...
/// </summary>
public record class IntrafiAccountEnrollmentListParams : ParamsBase
{
    /// <summary>
    ...
    public IntrafiAccountEnrollmentListParams() { }
...
#pragma warning disable CS8618
    ...
    public IntrafiAccountEnrollmentListParams(
        ...
        : base(intrafiAccountEnrollmentListParams) { }
...
#pragma warning restore CS8618
    ...
    public static IntrafiAccountEnrollmentListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(IntrafiAccountEnrollmentListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/intrafi_account_enrollments"
        )
        {
...
sealed class InConverter : JsonConverter<In>
{
    ...
    )
    {
        ...
        {
            "pending_enrolling" => In.PendingEnrolling,
            "enrolled" => In.Enrolled,
            "pending_unenrolling" => In.PendingUnenrolling,
            "unenrolled" => In.Unenrolled,
    ...
    public override void Write(Utf8JsonWriter writer, In value, JsonSerializerOptions options)
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                In.PendingEnrolling => "pending_enrolling",
                In.Enrolled => "enrolled",
                In.PendingUnenrolling => "pending_unenrolling",
                In.Unenrolled => "unenrolled",
