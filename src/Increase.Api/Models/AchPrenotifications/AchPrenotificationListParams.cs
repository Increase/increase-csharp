...
/// </summary>
public record class AchPrenotificationListParams : ParamsBase
{
    ...
    public AchPrenotificationListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AchPrenotificationListParams(AchPrenotificationListParams achPrenotificationListParams)
        : base(achPrenotificationListParams) { }
...
#pragma warning restore CS8618
    ...
    public static AchPrenotificationListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AchPrenotificationListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/ach_prenotifications")
        {
