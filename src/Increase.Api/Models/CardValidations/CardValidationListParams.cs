...
/// </summary>
public record class CardValidationListParams : ParamsBase
{
    /// <summary>
    ...
    public CardValidationListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CardValidationListParams(CardValidationListParams cardValidationListParams)
        : base(cardValidationListParams) { }
...
#pragma warning restore CS8618
    ...
    public static CardValidationListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CardValidationListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new System::UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/card_validations")
        {
...
{
    /// <summary>
    /// Filter Card Validations by status. For GET requests, this should be encoded
