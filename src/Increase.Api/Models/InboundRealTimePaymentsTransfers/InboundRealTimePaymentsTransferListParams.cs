...
/// </summary>
public record class InboundRealTimePaymentsTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public InboundRealTimePaymentsTransferListParams() { }
...
#pragma warning disable CS8618
    ...
    public InboundRealTimePaymentsTransferListParams(
        ...
        : base(inboundRealTimePaymentsTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static InboundRealTimePaymentsTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(InboundRealTimePaymentsTransferListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/inbound_real_time_payments_transfers"
        )
        {
