...
/// </summary>
public record class BeneficialOwnerListParams : ParamsBase
{
    /// <summary>
    ...
    public required string EntityID
    {
        get
        {
            ...
            return this._rawQueryData.GetNotNullClass<string>("entity_id");
        }
        init { this._rawQueryData.Set("entity_id", value); }
    }
    ...
    public BeneficialOwnerListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BeneficialOwnerListParams(BeneficialOwnerListParams beneficialOwnerListParams)
        : base(beneficialOwnerListParams) { }
...
#pragma warning restore CS8618
    ...
    public static BeneficialOwnerListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(BeneficialOwnerListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/entity_beneficial_owners")
        {
