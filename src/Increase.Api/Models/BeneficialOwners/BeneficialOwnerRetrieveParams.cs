...
/// </summary>
public record class BeneficialOwnerRetrieveParams : ParamsBase
{
    public string? EntityBeneficialOwnerID { get; init; }

    public BeneficialOwnerRetrieveParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BeneficialOwnerRetrieveParams(
        BeneficialOwnerRetrieveParams beneficialOwnerRetrieveParams
    )
        : base(beneficialOwnerRetrieveParams)
    {
        this.EntityBeneficialOwnerID = beneficialOwnerRetrieveParams.EntityBeneficialOwnerID;
    }
...
#pragma warning restore CS8618
    ...
    public static BeneficialOwnerRetrieveParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string entityBeneficialOwnerID
    )
    ...
    public virtual bool Equals(BeneficialOwnerRetrieveParams? other)
    {
        if (other == null)
        {
            return false;
