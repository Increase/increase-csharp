...
/// <summary>
/// An Inbound FedNow Transfer is a FedNow transfer initiated outside of Increase
/// to your account.
/// </summary>
[JsonConverter(typeof(JsonModelConverter<InboundFednowTransfer, InboundFednowTransferFromRaw>))]
public sealed record class InboundFednowTransfer : JsonModel
{
    /// <summary>
    ...
    /// be `inbound_fednow_transfer`.
    /// </summary>
    public required ApiEnum<string, global::Increase.Api.Models.InboundFednowTransfers.Type> Type
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullClass<
                ApiEnum<string, global::Increase.Api.Models.InboundFednowTransfers.Type>
            >("type");
        }
    ...
    public InboundFednowTransfer() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public InboundFednowTransfer(InboundFednowTransfer inboundFednowTransfer)
        : base(inboundFednowTransfer) { }
#pragma warning restore CS8618

    public InboundFednowTransfer(IReadOnlyDictionary<string, JsonElement> rawData)
    {
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    InboundFednowTransfer(FrozenDictionary<string, JsonElement> rawData)
    {
        this._rawData = new(rawData);
    }
#pragma warning restore CS8618

    /// <inheritdoc cref="InboundFednowTransferFromRaw.FromRawUnchecked"/>
    public static InboundFednowTransfer FromRawUnchecked(
...
class InboundFednowTransferFromRaw : IFromRawJson<InboundFednowTransfer>
{
    /// <inheritdoc/>
    public InboundFednowTransfer FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawData
    ) => InboundFednowTransfer.FromRawUnchecked(rawData);
}
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public Confirmation(string transferID)
        : this()
    {
...
sealed class TypeConverter : JsonConverter<global::Increase.Api.Models.InboundFednowTransfers.Type>
{
    public override global::Increase.Api.Models.InboundFednowTransfers.Type Read(
        ref Utf8JsonReader reader,
        System::Type typeToConvert,
        JsonSerializerOptions options
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            "inbound_fednow_transfer" => global::Increase
                .Api
                .Models
                .InboundFednowTransfers
                .Type
                .InboundFednowTransfer,
            _ => (global::Increase.Api.Models.InboundFednowTransfers.Type)(-1),
        };
    }

    public override void Write(
        Utf8JsonWriter writer,
        global::Increase.Api.Models.InboundFednowTransfers.Type value,
        JsonSerializerOptions options
    )
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                global::Increase.Api.Models.InboundFednowTransfers.Type.InboundFednowTransfer =>
