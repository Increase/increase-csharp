...
/// </summary>
public record class InboundCheckDepositListParams : ParamsBase
{
    /// <summary>
    ...
    public string? CheckTransferID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("check_transfer_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("check_transfer_id", value);
        }
    }
    ...
    public InboundCheckDepositListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public InboundCheckDepositListParams(
        InboundCheckDepositListParams inboundCheckDepositListParams
    )
        : base(inboundCheckDepositListParams) { }
...
#pragma warning restore CS8618
    ...
    public static InboundCheckDepositListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(InboundCheckDepositListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/inbound_check_deposits")
        {
