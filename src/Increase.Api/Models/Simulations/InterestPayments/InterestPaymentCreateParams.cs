...
namespace Increase.Api.Models.Simulations.InterestPayments;

/// <summary>
/// Simulates an interest payment to your account. In production, this happens automatically
...
/// </summary>
public record class InterestPaymentCreateParams : ParamsBase
{
    ...
    public InterestPaymentCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public InterestPaymentCreateParams(InterestPaymentCreateParams interestPaymentCreateParams)
        : base(interestPaymentCreateParams)
    {
        this._rawBodyData = new(interestPaymentCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static InterestPaymentCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(InterestPaymentCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/simulations/interest_payments"
        )
        {
