...
namespace Increase.Api.Models.Simulations.CardFuelConfirmations;
...
/// </summary>
public record class CardFuelConfirmationCreateParams : ParamsBase
{
    ...
    public CardFuelConfirmationCreateParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CardFuelConfirmationCreateParams(
        CardFuelConfirmationCreateParams cardFuelConfirmationCreateParams
    )
        : base(cardFuelConfirmationCreateParams)
    {
        this._rawBodyData = new(cardFuelConfirmationCreateParams._rawBodyData);
    }
...
#pragma warning restore CS8618
    ...
    public static CardFuelConfirmationCreateParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        IReadOnlyDictionary<string, JsonElement> rawBodyData
    )
    ...
    public virtual bool Equals(CardFuelConfirmationCreateParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/simulations/card_fuel_confirmations"
        )
        {
