...
/// <summary>
/// Simulates setting an [Entity](#entities)'s validation under the managed compliance
/// regime. Any existing managed compliance validation on the Entity will be marked
