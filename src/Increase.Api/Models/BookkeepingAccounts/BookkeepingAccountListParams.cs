...
/// </summary>
public record class BookkeepingAccountListParams : ParamsBase
{
    /// <summary>
    ...
    public BookkeepingAccountListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BookkeepingAccountListParams(BookkeepingAccountListParams bookkeepingAccountListParams)
        : base(bookkeepingAccountListParams) { }
...
#pragma warning restore CS8618
    ...
    public static BookkeepingAccountListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(BookkeepingAccountListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/bookkeeping_accounts")
        {
