...
/// </summary>
public record class CardPushTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public CardPushTransferListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CardPushTransferListParams(CardPushTransferListParams cardPushTransferListParams)
        : base(cardPushTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static CardPushTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CardPushTransferListParams? other)
    {
        if (other == null)
        {
            return false;
