...
/// </summary>
public record class DigitalCardProfileListParams : ParamsBase
{
    /// <summary>
    ...
    public DigitalCardProfileListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DigitalCardProfileListParams(DigitalCardProfileListParams digitalCardProfileListParams)
        : base(digitalCardProfileListParams) { }
...
#pragma warning restore CS8618
    ...
    public static DigitalCardProfileListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(DigitalCardProfileListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/digital_card_profiles"
        )
        {
