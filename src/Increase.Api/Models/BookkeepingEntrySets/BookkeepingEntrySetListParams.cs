...
/// </summary>
public record class BookkeepingEntrySetListParams : ParamsBase
{
    /// <summary>
    ...
    public string? TransactionID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("transaction_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("transaction_id", value);
        }
    }

    public BookkeepingEntrySetListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public BookkeepingEntrySetListParams(
        BookkeepingEntrySetListParams bookkeepingEntrySetListParams
    )
        : base(bookkeepingEntrySetListParams) { }
...
#pragma warning restore CS8618
    ...
    public static BookkeepingEntrySetListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(BookkeepingEntrySetListParams? other)
    {
        if (other == null)
        {
            return false;
