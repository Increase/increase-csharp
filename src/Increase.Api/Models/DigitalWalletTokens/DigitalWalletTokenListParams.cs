...
/// </summary>
public record class DigitalWalletTokenListParams : ParamsBase
{
    /// <summary>
    ...
    public string? CardID
    {
        get
        {
            ...
            return this._rawQueryData.GetNullableClass<string>("card_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("card_id", value);
        }
    }
    ...
    public DigitalWalletTokenListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DigitalWalletTokenListParams(DigitalWalletTokenListParams digitalWalletTokenListParams)
        : base(digitalWalletTokenListParams) { }
...
#pragma warning restore CS8618
    ...
    public static DigitalWalletTokenListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(DigitalWalletTokenListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/digital_wallet_tokens")
        {
