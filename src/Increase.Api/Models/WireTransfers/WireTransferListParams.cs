...
/// </summary>
public record class WireTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public WireTransferListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WireTransferListParams(WireTransferListParams wireTransferListParams)
        : base(wireTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static WireTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(WireTransferListParams? other)
    {
        if (other == null)
        {
            return false;
