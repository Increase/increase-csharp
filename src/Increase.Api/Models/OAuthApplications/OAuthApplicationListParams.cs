...
/// </summary>
public record class OAuthApplicationListParams : ParamsBase
{
    ...
    public OAuthApplicationListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public OAuthApplicationListParams(OAuthApplicationListParams oauthApplicationListParams)
        : base(oauthApplicationListParams) { }
...
#pragma warning restore CS8618
    ...
    public static OAuthApplicationListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(OAuthApplicationListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/oauth_applications"
        )
        {
