...
public sealed record class Submission : JsonModel
{
    ...
    /// deadline for the return entry to be made available to the ODFI no later than
    /// the opening of business on the second banking day following the Settlement
