...
/// </summary>
public record class AchTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public string? ExternalAccountID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("external_account_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("external_account_id", value);
        }
    }
    ...
    public AchTransferListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AchTransferListParams(AchTransferListParams achTransferListParams)
        : base(achTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static AchTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AchTransferListParams? other)
    {
        if (other == null)
        {
            return false;
...
sealed class InConverter : JsonConverter<In>
{
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            "pending_transfer_session_confirmation" => In.PendingTransferSessionConfirmation,
    ...
    public override void Write(Utf8JsonWriter writer, In value, JsonSerializerOptions options)
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ...
                In.PendingTransferSessionConfirmation => "pending_transfer_session_confirmation",
