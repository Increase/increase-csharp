...
/// </summary>
public record class CheckDepositListParams : ParamsBase
{
    /// <summary>
    ...
    public CheckDepositListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CheckDepositListParams(CheckDepositListParams checkDepositListParams)
        : base(checkDepositListParams) { }
...
#pragma warning restore CS8618
    ...
    public static CheckDepositListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CheckDepositListParams? other)
    {
        if (other == null)
        {
            return false;
