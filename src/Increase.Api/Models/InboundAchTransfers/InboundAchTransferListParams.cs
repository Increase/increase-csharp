...
/// </summary>
public record class InboundAchTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public InboundAchTransferListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public InboundAchTransferListParams(InboundAchTransferListParams inboundAchTransferListParams)
        : base(inboundAchTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static InboundAchTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(InboundAchTransferListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override System::Uri Url(ClientOptions options)
    {
        return new System::UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/inbound_ach_transfers"
        )
        {
