...
/// </summary>
public record class FednowTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public FednowTransferListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public FednowTransferListParams(FednowTransferListParams fednowTransferListParams)
        : base(fednowTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static FednowTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(FednowTransferListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new System::UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/fednow_transfers")
        {
