...
/// </summary>
public record class CardPurchaseSupplementListParams : ParamsBase
{
    /// <summary>
    ...
    public string? CardPaymentID
    {
        get
        {
            ...
            return this._rawQueryData.GetNullableClass<string>("card_payment_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("card_payment_id", value);
        }
    }
    ...
    public CardPurchaseSupplementListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CardPurchaseSupplementListParams(
        CardPurchaseSupplementListParams cardPurchaseSupplementListParams
    )
        : base(cardPurchaseSupplementListParams) { }
...
#pragma warning restore CS8618
    ...
    public static CardPurchaseSupplementListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CardPurchaseSupplementListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/card_purchase_supplements"
        )
        {
