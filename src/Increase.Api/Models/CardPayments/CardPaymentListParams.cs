...
/// </summary>
public record class CardPaymentListParams : ParamsBase
{
    /// <summary>
    ...
    public CardPaymentListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public CardPaymentListParams(CardPaymentListParams cardPaymentListParams)
        : base(cardPaymentListParams) { }
...
#pragma warning restore CS8618
    ...
    public static CardPaymentListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(CardPaymentListParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/card_payments")
        {
