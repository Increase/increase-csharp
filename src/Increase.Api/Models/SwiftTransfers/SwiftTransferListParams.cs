...
/// </summary>
public record class SwiftTransferListParams : ParamsBase
{
    /// <summary>
    ...
    public SwiftTransferListParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public SwiftTransferListParams(SwiftTransferListParams swiftTransferListParams)
        : base(swiftTransferListParams) { }
...
#pragma warning restore CS8618
    ...
    public static SwiftTransferListParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(SwiftTransferListParams? other)
    {
        if (other == null)
        {
            return false;
...
sealed class InConverter : JsonConverter<In>
{
    ...
    )
    {
        return JsonSerializer.Deserialize<string>(ref reader, options) switch
        {
            ...
            "pending_initiating" => In.PendingInitiating,
    ...
    public override void Write(Utf8JsonWriter writer, In value, JsonSerializerOptions options)
    {
        JsonSerializer.Serialize(
            ...
            value switch
            {
                ...
                In.PendingInitiating => "pending_initiating",
                In.Initiated => "initiated",
