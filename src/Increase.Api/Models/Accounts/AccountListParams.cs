...
public record class AccountListParams : ParamsBase
{
    ...
    public string? InformationalEntityID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("informational_entity_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("informational_entity_id", value);
        }
    }
    ...
    public string? ProgramID
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("program_id");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("program_id", value);
        }
    }
