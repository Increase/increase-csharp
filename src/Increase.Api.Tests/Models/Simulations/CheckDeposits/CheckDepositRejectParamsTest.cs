...
public class CheckDepositRejectParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CheckDepositRejectParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/simulations/check_deposits/check_deposit_f06n9gpg7sxn8t19lfc1/reject"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CheckDepositRejectParams copied = new(parameters);
