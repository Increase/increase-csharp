...
public class EntityValidationParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new EntityValidationParams
        {
        ...
        ApiEnum<string, Status> expectedStatus = Status.Invalid;
    ...
    {
        EntityValidationParams parameters = new()
        {
            EntityID = "entity_n8y8tnk2p9339ti393yi",
            Issues = [new(Category.EntityTaxIdentifier)],
            Status = Status.Invalid,
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/simulations/entities/entity_n8y8tnk2p9339ti393yi/validation"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        EntityValidationParams copied = new(parameters);
