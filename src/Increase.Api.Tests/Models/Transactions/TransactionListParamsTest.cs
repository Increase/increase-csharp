...
public class TransactionListParamsTest : TestBase
{
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/transactions?account_id=account_id&category.in=account_transfer_intention&created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&limit=1&route_id=route_id"
                ),
                url
            )
        );
...
public class InTest : TestBase
{
    ...
    [InlineData(In.FednowTransferReturn)]
    ...
    [InlineData(In.SepaInstantTransferAcceptance)]
    [InlineData(In.Other)]
