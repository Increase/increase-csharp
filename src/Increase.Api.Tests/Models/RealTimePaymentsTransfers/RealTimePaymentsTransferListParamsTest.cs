...
public class RealTimePaymentsTransferListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new RealTimePaymentsTransferListParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/real_time_payments_transfers?account_id=account_id&created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&external_account_id=external_account_id&idempotency_key=x&limit=1&status.in=pending_approval"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        RealTimePaymentsTransferListParams copied = new(parameters);
