...
public class CardDisputeListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CardDisputeListParams
        {
            CreatedAt = new()
            {
            ...
            IdempotencyKey = "x",
            Limit = 1,
            Status = new() { In = [In.UserSubmissionRequired] },
        };
        ...
        Status expectedStatus = new() { In = [In.UserSubmissionRequired] };
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/card_disputes?created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&idempotency_key=x&limit=1&status.in=user_submission_required"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CardDisputeListParams copied = new(parameters);
...
public class StatusTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Status { In = [In.UserSubmissionRequired] };

        List<ApiEnum<string, In>> expectedIn = [In.UserSubmissionRequired];
...
{
    [Theory]
    [InlineData(In.UserSubmissionRequired)]
    [InlineData(In.PendingUserSubmissionReviewing)]
    [InlineData(In.PendingUserSubmissionSubmitting)]
    [InlineData(In.PendingUserWithdrawalSubmitting)]
