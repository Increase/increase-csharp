...
public class EventCategoryTest : TestBase
{
    ...
    [InlineData(EventCategory.InboundRealTimePaymentsRequestForPaymentCreated)]
    [InlineData(EventCategory.InboundRealTimePaymentsRequestForPaymentUpdated)]
    ...
    [InlineData(EventCategory.LoanApplicationCreated)]
    [InlineData(EventCategory.LoanApplicationUpdated)]
    [InlineData(EventCategory.LoanDistributionCreated)]
    [InlineData(EventCategory.LoanObligationCreated)]
    [InlineData(EventCategory.LoanOfferCreated)]
    [InlineData(EventCategory.LoanOfferUpdated)]
    [InlineData(EventCategory.LoanPurchaseCreated)]
    [InlineData(EventCategory.LockboxCreated)]
    [InlineData(EventCategory.LockboxUpdated)]
    [InlineData(EventCategory.LockboxAddressCreated)]
    [InlineData(EventCategory.LockboxAddressUpdated)]
    ...
    [InlineData(EventCategory.PlaidProcessorTokenCreated)]
    [InlineData(EventCategory.CheckbookCreated)]
    [InlineData(EventCategory.CheckbookUpdated)]
    ...
    [InlineData(EventCategory.SepaInstantTransferCreated)]
    [InlineData(EventCategory.SepaInstantTransferUpdated)]
    ...
    [InlineData(EventCategory.UkFasterPaymentSystemTransferCreated)]
    [InlineData(EventCategory.UkFasterPaymentSystemTransferUpdated)]
