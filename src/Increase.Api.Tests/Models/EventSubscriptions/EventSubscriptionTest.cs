...
public class EventSubscriptionSelectedEventCategoryEventCategoryTest : TestBase
{
    ...
    [InlineData(
        EventSubscriptions::EventSubscriptionSelectedEventCategoryEventCategory.InboundRealTimePaymentsRequestForPaymentCreated
    )]
    [InlineData(
        EventSubscriptions::EventSubscriptionSelectedEventCategoryEventCategory.InboundRealTimePaymentsRequestForPaymentUpdated
    )]
    [InlineData(
    ...
    [InlineData(
        EventSubscriptions::EventSubscriptionSelectedEventCategoryEventCategory.LoanApplicationCreated
    )]
    [InlineData(
    ...
    [InlineData(
        EventSubscriptions::EventSubscriptionSelectedEventCategoryEventCategory.LoanObligationCreated
    )]
    [InlineData(
    ...
    [InlineData(
        EventSubscriptions::EventSubscriptionSelectedEventCategoryEventCategory.SepaInstantTransferCreated
    )]
    [InlineData(
        EventSubscriptions::EventSubscriptionSelectedEventCategoryEventCategory.SepaInstantTransferUpdated
    )]
    [InlineData(
