...
public class WireDrawdownRequestRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new WireDrawdownRequestRetrieveParams
        {
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/wire_drawdown_requests/wire_drawdown_request_q6lmocus3glo0lr2bfv3"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        WireDrawdownRequestRetrieveParams copied = new(parameters);
