...
public class SwiftTransferListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new SwiftTransferListParams
        {
    ...
    {
        SwiftTransferListParams parameters = new()
        {
            AccountID = "account_id",
            CreatedAt = new()
            {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/swift_transfers?account_id=account_id&created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&idempotency_key=x&limit=1&status.in=pending_approval"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        SwiftTransferListParams copied = new(parameters);
...
public class InTest : TestBase
{
    ...
    [InlineData(In.PendingInitiating)]
    [InlineData(In.Initiated)]
