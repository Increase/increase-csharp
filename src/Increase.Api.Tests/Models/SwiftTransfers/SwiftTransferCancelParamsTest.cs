...
public class SwiftTransferCancelParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new SwiftTransferCancelParams
        {
    ...
    {
        SwiftTransferCancelParams parameters = new()
        {
            SwiftTransferID = "swift_transfer_29h21xkng03788zwd3fh",
        };
    ...
    public void CopyConstructor_Works()
    {
        ...
        SwiftTransferCancelParams copied = new(parameters);
