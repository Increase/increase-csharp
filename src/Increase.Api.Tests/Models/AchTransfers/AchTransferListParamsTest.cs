...
public class AchTransferListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new AchTransferListParams
        {
            ...
            IdempotencyKey = "x",
            Limit = 1,
            Status = new() { In = [In.PendingApproval] },
        };
        ...
        Status expectedStatus = new() { In = [In.PendingApproval] };
    ...
    public void OptionalNonNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.False(parameters.RawQueryData.ContainsKey("external_account_id"));
    ...
    {
        AchTransferListParams parameters = new()
        {
            AccountID = "account_id",
            CreatedAt = new()
            {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/ach_transfers?account_id=account_id&created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&external_account_id=external_account_id&idempotency_key=x&limit=1&status.in=pending_approval"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        AchTransferListParams copied = new(parameters);
...
public class StatusTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Status { In = [In.PendingApproval] };

        List<ApiEnum<string, In>> expectedIn = [In.PendingApproval];
...
public class InTest : TestBase
{
    ...
    [InlineData(In.PendingTransferSessionConfirmation)]
