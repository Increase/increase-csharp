...
public class AccountTransferCancelParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new AccountTransferCancelParams
        {
    ...
    {
        AccountTransferCancelParams parameters = new()
        {
            AccountTransferID = "account_transfer_7k9qe1ysdgqztnt63l7n",
        };
    ...
    public void CopyConstructor_Works()
    {
        ...
        AccountTransferCancelParams copied = new(parameters);
