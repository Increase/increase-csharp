...
public class BeneficialOwnerListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new BeneficialOwnerListParams
        {
            EntityID = "entity_id",
            Cursor = "cursor",
            IdempotencyKey = "x",
    ...
    {
        var parameters = new BeneficialOwnerListParams { EntityID = "entity_id" };
    ...
    {
        BeneficialOwnerListParams parameters = new()
        {
            EntityID = "entity_id",
            Cursor = "cursor",
            IdempotencyKey = "x",
    ...
    public void CopyConstructor_Works()
    {
        ...
        BeneficialOwnerListParams copied = new(parameters);
