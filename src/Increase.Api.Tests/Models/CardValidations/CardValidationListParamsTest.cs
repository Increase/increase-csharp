...
public class CardValidationListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new CardValidationListParams
        {
            ...
            IdempotencyKey = "x",
            Limit = 1,
            Status = new() { In = [In.RequiresAttention] },
        };
        ...
        Status expectedStatus = new() { In = [In.RequiresAttention] };
    ...
    {
        CardValidationListParams parameters = new()
        {
            AccountID = "account_id",
            CreatedAt = new()
            {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/card_validations?account_id=account_id&created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&idempotency_key=x&limit=1&status.in=requires_attention"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        CardValidationListParams copied = new(parameters);
...
public class StatusTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Status { In = [In.RequiresAttention] };

        List<ApiEnum<string, In>> expectedIn = [In.RequiresAttention];
