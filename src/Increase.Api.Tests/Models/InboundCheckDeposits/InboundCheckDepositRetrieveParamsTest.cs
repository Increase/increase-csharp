...
public class InboundCheckDepositRetrieveParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new InboundCheckDepositRetrieveParams
        {
    ...
    {
        InboundCheckDepositRetrieveParams parameters = new()
        {
            InboundCheckDepositID = "inbound_check_deposit_zoshvqybq0cjjm31mra",
        };
        ...
        Assert.Equal(
            new Uri(
                "https://api.increase.com/inbound_check_deposits/inbound_check_deposit_zoshvqybq0cjjm31mra"
            ),
            url
        );
    }
    ...
    public void CopyConstructor_Works()
    {
        ...
        InboundCheckDepositRetrieveParams copied = new(parameters);
