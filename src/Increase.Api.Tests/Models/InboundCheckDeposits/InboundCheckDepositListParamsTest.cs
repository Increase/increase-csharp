...
public class InboundCheckDepositListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new InboundCheckDepositListParams
        {
        ...
        string expectedCheckTransferID = "check_transfer_id";
    ...
    public void OptionalNonNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(parameters.CheckTransferID);
        Assert.False(parameters.RawQueryData.ContainsKey("check_transfer_id"));
    ...
    {
        InboundCheckDepositListParams parameters = new()
        {
            AccountID = "account_id",
            CheckTransferID = "check_transfer_id",
            CreatedAt = new()
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/inbound_check_deposits?account_id=account_id&check_transfer_id=check_transfer_id&created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&limit=1"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        InboundCheckDepositListParams copied = new(parameters);
