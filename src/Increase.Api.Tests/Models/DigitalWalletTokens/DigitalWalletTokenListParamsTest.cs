...
public class DigitalWalletTokenListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new DigitalWalletTokenListParams
        {
            CardID = "card_id",
            CreatedAt = new()
            {
    ...
    public void OptionalNonNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.False(parameters.RawQueryData.ContainsKey("card_id"));
    ...
    {
        DigitalWalletTokenListParams parameters = new()
        {
            CardID = "card_id",
            CreatedAt = new()
            {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/digital_wallet_tokens?card_id=card_id&created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&limit=1"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        DigitalWalletTokenListParams copied = new(parameters);
