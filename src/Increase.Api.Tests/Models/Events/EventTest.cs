...
public class EventCategoryTest : TestBase
{
    ...
    [InlineData(Events::EventCategory.InboundRealTimePaymentsRequestForPaymentCreated)]
    [InlineData(Events::EventCategory.InboundRealTimePaymentsRequestForPaymentUpdated)]
    ...
    [InlineData(Events::EventCategory.LoanApplicationCreated)]
    [InlineData(Events::EventCategory.LoanApplicationUpdated)]
    [InlineData(Events::EventCategory.LoanDistributionCreated)]
    [InlineData(Events::EventCategory.LoanObligationCreated)]
    [InlineData(Events::EventCategory.LoanOfferCreated)]
    [InlineData(Events::EventCategory.LoanOfferUpdated)]
    [InlineData(Events::EventCategory.LoanPurchaseCreated)]
    [InlineData(Events::EventCategory.LockboxCreated)]
    [InlineData(Events::EventCategory.LockboxUpdated)]
    [InlineData(Events::EventCategory.LockboxAddressCreated)]
    [InlineData(Events::EventCategory.LockboxAddressUpdated)]
    ...
    [InlineData(Events::EventCategory.PlaidProcessorTokenCreated)]
    [InlineData(Events::EventCategory.CheckbookCreated)]
    [InlineData(Events::EventCategory.CheckbookUpdated)]
    ...
    [InlineData(Events::EventCategory.SepaInstantTransferCreated)]
    [InlineData(Events::EventCategory.SepaInstantTransferUpdated)]
    ...
    [InlineData(Events::EventCategory.UkFasterPaymentSystemTransferCreated)]
    [InlineData(Events::EventCategory.UkFasterPaymentSystemTransferUpdated)]
