...
public class EventCategoryTest : TestBase
{
    ...
    [InlineData(Events::EventCategory.DocumentCreated)]
    ...
    [InlineData(Events::EventCategory.LegacyCardDisputeCreated)]
    [InlineData(Events::EventCategory.LegacyCardDisputeUpdated)]
