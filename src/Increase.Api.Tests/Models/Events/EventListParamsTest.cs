...
public class InTest : TestBase
{
    ...
    [InlineData(In.InboundRealTimePaymentsRequestForPaymentCreated)]
    [InlineData(In.InboundRealTimePaymentsRequestForPaymentUpdated)]
    ...
    [InlineData(In.LoanApplicationCreated)]
    [InlineData(In.LoanApplicationUpdated)]
    [InlineData(In.LoanDistributionCreated)]
    [InlineData(In.LoanObligationCreated)]
    [InlineData(In.LoanOfferCreated)]
    [InlineData(In.LoanOfferUpdated)]
    [InlineData(In.LoanPurchaseCreated)]
    [InlineData(In.LockboxCreated)]
    [InlineData(In.LockboxUpdated)]
    [InlineData(In.LockboxAddressCreated)]
    [InlineData(In.LockboxAddressUpdated)]
    ...
    [InlineData(In.PlaidProcessorTokenCreated)]
    [InlineData(In.CheckbookCreated)]
    [InlineData(In.CheckbookUpdated)]
    ...
    [InlineData(In.SepaInstantTransferCreated)]
    [InlineData(In.SepaInstantTransferUpdated)]
    [InlineData(In.SwiftTransferCreated)]
    [InlineData(In.SwiftTransferUpdated)]
    [InlineData(In.TransactionCreated)]
    [InlineData(In.UkFasterPaymentSystemTransferCreated)]
    [InlineData(In.UkFasterPaymentSystemTransferUpdated)]
