...
public class UnwrapWebhookEventCategoryTest : TestBase
{
    ...
    [InlineData(UnwrapWebhookEventCategory.InboundRealTimePaymentsRequestForPaymentCreated)]
    [InlineData(UnwrapWebhookEventCategory.InboundRealTimePaymentsRequestForPaymentUpdated)]
    ...
    [InlineData(UnwrapWebhookEventCategory.LoanApplicationCreated)]
    [InlineData(UnwrapWebhookEventCategory.LoanApplicationUpdated)]
    [InlineData(UnwrapWebhookEventCategory.LoanDistributionCreated)]
    [InlineData(UnwrapWebhookEventCategory.LoanObligationCreated)]
    [InlineData(UnwrapWebhookEventCategory.LoanOfferCreated)]
    [InlineData(UnwrapWebhookEventCategory.LoanOfferUpdated)]
    [InlineData(UnwrapWebhookEventCategory.LoanPurchaseCreated)]
    [InlineData(UnwrapWebhookEventCategory.LockboxCreated)]
    [InlineData(UnwrapWebhookEventCategory.LockboxUpdated)]
    [InlineData(UnwrapWebhookEventCategory.LockboxAddressCreated)]
    [InlineData(UnwrapWebhookEventCategory.LockboxAddressUpdated)]
    ...
    [InlineData(UnwrapWebhookEventCategory.PlaidProcessorTokenCreated)]
    [InlineData(UnwrapWebhookEventCategory.CheckbookCreated)]
    [InlineData(UnwrapWebhookEventCategory.CheckbookUpdated)]
    ...
    [InlineData(UnwrapWebhookEventCategory.SepaInstantTransferCreated)]
    [InlineData(UnwrapWebhookEventCategory.SepaInstantTransferUpdated)]
    ...
    [InlineData(UnwrapWebhookEventCategory.UkFasterPaymentSystemTransferCreated)]
    [InlineData(UnwrapWebhookEventCategory.UkFasterPaymentSystemTransferUpdated)]
