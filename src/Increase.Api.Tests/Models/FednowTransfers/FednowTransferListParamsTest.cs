...
public class FednowTransferListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new FednowTransferListParams
        {
    ...
    {
        FednowTransferListParams parameters = new()
        {
            AccountID = "account_id",
            CreatedAt = new()
            {
        ...
        Assert.Equal(
            new Uri(
                "https://api.increase.com/fednow_transfers?account_id=account_id&created_at.after=2019-12-27T18%3a11%3a19.117Z&created_at.before=2019-12-27T18%3a11%3a19.117Z&created_at.on_or_after=2019-12-27T18%3a11%3a19.117Z&created_at.on_or_before=2019-12-27T18%3a11%3a19.117Z&cursor=cursor&external_account_id=external_account_id&idempotency_key=x&limit=1&status.in=pending_reviewing"
            ),
            url
        );
    }
