...
public class InboundAchTransferListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new InboundAchTransferListParams
        {
    ...
    {
        InboundAchTransferListParams parameters = new()
        {
            AccountID = "account_id",
            AccountNumberID = "account_number_id",
            CreatedAt = new()
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/inbound_ach_transfers?account_id=account_id&account_number_id=account_number_id&created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&limit=1&status.in=pending"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        InboundAchTransferListParams copied = new(parameters);
