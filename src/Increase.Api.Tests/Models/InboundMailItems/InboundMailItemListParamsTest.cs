...
public class InboundMailItemListParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        string expectedLockboxID = "lockbox_id";
    ...
    public void OptionalNonNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.Null(parameters.LockboxID);
        Assert.False(parameters.RawQueryData.ContainsKey("lockbox_id"));
    }
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.increase.com/inbound_mail_items?created_at.after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.before=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_after=2019-12-27T18%3a11%3a19.117%2b00%3a00&created_at.on_or_before=2019-12-27T18%3a11%3a19.117%2b00%3a00&cursor=cursor&limit=1&lockbox_id=lockbox_id"
                ),
                url
            )
        );
